...
class PasswordCracker:
    def __init__(self, file, wordlist, output: str = './steghide_crack_output'):
        self.file = file
    ...
    def _crack(self):
        while not self.passwords.empty():
            ...
            print(
                f'\033[34;1m\r[i] Progress: {self.iter}/{self.passwords_len} ({round(self.iter / self.passwords_len * 100, 2)}%)\033[0m',
                end='')
